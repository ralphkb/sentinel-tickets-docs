...
### Why is the panel missing my newly added ticket category?
When you add a new ticket category, you need to add the category `id` to the `categories` array in the configured panel that you wish to send in a channel.