...
transcriptName: "{channelName}-transcript" # The name of the generated transcript file, use {channelName} for the name of the ticket channel. The file extension will be based on the transcript type, .html for HTML transcripts and .txt for TXT transcripts
